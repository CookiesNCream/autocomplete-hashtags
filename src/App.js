/* By Linda Lim | Autocomplete Widget | BSD 3-Clause License | https://github.com/CookiesNCream/autocomplete-hashtags */
...
export default class App extends React.Component { /* The App React component is rendered via index.js */
  ...
  onSearchChange = ({ value }) => {
    this.setState({
      suggestions: defaultSuggestionsFilter(value, hashtags), /* Triggers a match string */
    });
  };
